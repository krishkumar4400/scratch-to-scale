    ...
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pb-0">
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
          <div className="flex items-center gap-3 shadow-sm shadow-blue-400 border border-blue-500 p-4  rounded-md">
          ...
          <div className="flex items-center gap-3 shadow-sm shadow-blue-400 border border-blue-500 p-4 w-56 rounded-md">
        ...
        <div>
          ...
          <div className="flex flex-col items-center max-w-5xl w-full overflow-hidden rounded-md bg-white border border-gray-500/30">
            <table className="table-fixed md:table-auto w-full overflow-hidden">
              <thead className="text-gray-800 border-b border-gray-500/20 text-sm text-left">
                <tr>
